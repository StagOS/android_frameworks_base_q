...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    private static boolean isPowerMenuBlurEnabled(Context context) {
        return Settings.System.getInt(context.getContentResolver(),
                Settings.System.POWERMENU_BLUR, 1) != 0;
    }
    ...
    private static final class ActionsDialog extends Dialog implements DialogInterface,
        ...
        ActionsDialog(Context context, MyAdapter adapter,
            ...
            if(isPowerMenuBlurEnabled(mContext) && surfaceBitmap != null){
        ...
        private void initializePanel() {
            ...
            if (rotation != RotationUtils.ROTATION_NONE) {
                ...
                if(!isPowerMenuBlurEnabled(mContext))
